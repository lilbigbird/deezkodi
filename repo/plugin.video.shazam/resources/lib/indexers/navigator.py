...
class navigator:
    def root(self):
        api_keys.chk()
        self.addDirectoryItem(32000, 'szmOneclick', '1click.png', 'DefaultMovies.png')
    ...
    def szmOneclick(self):
        self.addDirectoryItem(32638, 'szmMovies', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32639, 'szmTvshows', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32640, 'szmDocs', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32641, 'lists10', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32010, 'searchNavigator', 'search.png', 'DefaultAddonsSearch.png')
        self.addDirectoryItem(32008, 'toolNavigator', 'tools.png', 'DefaultAddonProgram.png')         
        self.addDirectoryItem(32076, 'ruSettings', 'resolveurl.png', 'DefaultTVShows.png')
        self.endDirectory()
        
    def szmTvshows(self):
        self.addDirectoryItem(32642, 'lists43', '1click.png', 'DefaultTVShows.png')        
        self.addDirectoryItem(32643, 'lists1', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32644, 'lists45', '1click.png', 'DefaultTVShows.png')        
        self.addDirectoryItem(32645, 'lists11', '1click.png', 'DefaultTVShows.png')        
        self.endDirectory()         
        
    def szmMovies(self):
        self.addDirectoryItem(32646, 'extinfo', '1click.png', 'DefaultMovies.png')        
        self.addDirectoryItem(32647, 'lists49', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32648, 'lists50', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32649, 'lists7', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32650, 'lists51', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32651, 'lists8', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32652, 'lists44', '1click.png', 'DefaultTVShows.png')        
        self.addDirectoryItem(32653, 'lists9', '1click.png', 'DefaultTVShows.png')      
        self.addDirectoryItem(32654, 'szmYears', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32655, 'szm4kYears', '1click.png', 'DefaultTVShows.png')        
        self.addDirectoryItem(32656, 'szmGenre', '1click.png', 'DefaultTVShows.png')        
        self.addDirectoryItem(32657, 'lists20', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32658, 'lists29', '1click.png', 'DefaultTVShows.png')         
        self.endDirectory()
        
    def szmGenre(self):
        self.addDirectoryItem(32667, 'lists21', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32668, 'lists22', '1click.png', 'DefaultMovies.png')         
        self.addDirectoryItem(32669, 'lists23', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32670, 'lists24', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32671, 'lists25', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32672, 'lists26', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32673, 'lists27', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32674, 'lists6', '1click.png', 'DefaultMovies.png') 
        self.addDirectoryItem(32675, 'lists28', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32676, 'lists30', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32677, 'lists31', '1click.png', 'DefaultTVShows.png') 
        self.addDirectoryItem(32678, 'lists32', '1click.png', 'DefaultTVShows.png') 
        self.addDirectoryItem(32679, 'lists33', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32680, 'lists34', '1click.png', 'DefaultTVShows.png')         
        self.endDirectory()        

    def szmYears(self):
        self.addDirectoryItem(32681, 'lists48', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32682, 'lists49', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32683, 'lists46', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32684, 'lists12', '1click.png', 'DefaultMovies.png')         
        self.addDirectoryItem(32685, 'lists13', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32686, 'lists14', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32687, 'lists15', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32688, 'lists16', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32689, 'lists17', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32690, 'lists18', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32691, 'lists19', '1click.png', 'DefaultTVShows.png')        
        self.endDirectory()

    def szm4kYears(self):
        self.addDirectoryItem(32692, 'lists51', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32693, 'lists8', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32694, 'lists47', '1click.png', 'DefaultMovies.png')
        self.addDirectoryItem(32695, 'lists35', '1click.png', 'DefaultMovies.png')         
        self.addDirectoryItem(32696, 'lists36', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32697, 'lists37', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32698, 'lists38', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32699, 'lists39', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32700, 'lists40', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32701, 'lists41', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32702, 'lists42', '1click.png', 'DefaultTVShows.png')        
        self.endDirectory()        

    def szmDocs(self):
        self.addDirectoryItem(32703, 'lists2', '1click.png', 'DefaultMovies.png') 
        self.addDirectoryItem(32704, 'lists3', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32705, 'lists4', '1click.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32706, 'lists5', '1click.png', 'DefaultTVShows.png')        
        self.endDirectory()        
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32659, 'movieMosts', 'featured.png', 'DefaultMovies.png')
        ...
        #self.addDirectoryItem(32660, 'movieKeywords2', 'imdb.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem(32661, 'tvMosts', 'featured.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        #self.addDirectoryItem('[COLOR=darkorange][B]Shazam[/B] : Changelog[/COLOR]', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32079, 'shazamscrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32076, 'smuSettings', 'resolveurl.png', 'DefaultAddonProgram.png', isFolder=False)
            ...
            #self.addDirectoryItem('[COLOR=darkorange][B]Orion[/B] : Install[/COLOR]', 'installOrion', 'orion.png', 'DefaultAddonProgram.png', isFolder=False)
        #else:
        ...
        self.addDirectoryItem(32662, 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32663, 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem(32664, 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32665, 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32666, 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
