...
#('https://api.themoviedb.org/3/movie/603?api_key=e3f3f431075f653b50c5f302f5ade04e&language=en-US',verify=False).json()
...
class tmdb:
    ...
    def build_data(self,url):
        ...
        all_urls = ["https://api.themoviedb.org/3/%s/%s?api_key=e3f3f431075f653b50c5f302f5ade04e&language=en&append_to_response=external_ids,videos,credits,release_dates,alternative_titles,translations"%(self.tv_movie,i['id']) for i in data['results']]
    ...
    def add_items(self,data_pre,tv_movie,order):
       try:
        ...
        url_params = 'plugin://plugin.video.metv19/?' + urlencode(params) 
        self.all_d[id]={}
    ...
    def fix_data_season(self,data,html,order):
             ...
             if not stop_data:
                 ...
                 url='https://api.themoviedb.org/3/tv/%s/season/%s?api_key=e3f3f431075f653b50c5f302f5ade04e&language=%s&append_to_response=external_ids'%(id,season,lang)
