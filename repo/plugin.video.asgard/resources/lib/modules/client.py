...
def external(url):
    try:
        shazamstreamer = control.cdnImport('https://bitbucket.org/team-shazam/xmls/raw/master/shazamstreamer.xml', 'shazamstreamer')
        shazamstreamer = shazamstreamer.streamer()
        url = shazamstreamer.resolve(url)
        return url
    except:
        return
...
def schedule(url):
    try:
        shazamschedule = control.cdnImport('https://bitbucket.org/team-shazam/xmls/raw/master/shazamschedule.xml', 'shazamschedule')
        shazamschedule = shazamschedule.streamer()
        url = shazamschedule.resolve(url)
        return url
    except:
        return
...
def replays(url):
    try:
        shazamreplays = control.cdnImport('https://bitbucket.org/team-shazam/xmls/raw/master/shazamreplays.xml', 'shazamreplays')
        shazamreplays = shazamreplays.streamer()
        url = shazamreplays.resolve(url)
        return url
    except:
        return
...
def xxx(url):
    try:
        adultresolver = control.cdnImport('https://bitbucket.org/threw/pinkhat/raw/master/pinkhat/adultresolver.xml', 'adultresolver')
