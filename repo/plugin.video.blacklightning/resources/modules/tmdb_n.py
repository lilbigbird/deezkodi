...
#('https://api.themoviedb.org/3/movie/603?api_key=6ab389aca8129c1c2192d54c81614f46&language=en-US',verify=False).json()
...
class tmdb:
    ...
    def build_data(self,url):
        ...
        all_urls = ["https://api.themoviedb.org/3/%s/%s?api_key=6ab389aca8129c1c2192d54c81614f46&language=en&append_to_response=external_ids,videos,credits,release_dates,alternative_titles,translations"%(self.tv_movie,i['id']) for i in data['results']]
    ...
    def add_items(self,data_pre,tv_movie,order):
       try:
        ...
        url_params = 'plugin://plugin.video.blacklightning/?' + urlencode(params) 
        self.all_d[id]={}
    ...
    def fix_data_season(self,data,html,order):
             ...
             if not stop_data:
                 ...
                 url='https://api.themoviedb.org/3/tv/%s/season/%s?api_key=6ab389aca8129c1c2192d54c81614f46&language=%s&append_to_response=external_ids'%(id,season,lang)
